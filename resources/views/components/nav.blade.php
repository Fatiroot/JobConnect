...
<head>
    ...
    <!-- Meta SEO -->
    <meta name="title" content="Artsy Collabs">
    ...
    <!-- Social media share -->
    <meta property="og:title" content="Artsy Collabs">
        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="" class="flex items-center">
                    <img src="{{ URL::asset('img/logo_art.png') }}" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Artsy <span
                            style="color: #a259ff">collabs</span></span>
                </a>
                <div class="flex items-center lg:order-2">

                    <a href="{{ route('register') }}"
                        class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Sign
                        Up</a>
                    <a href="{{ route('login') }}"
